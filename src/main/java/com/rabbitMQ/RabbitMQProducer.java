...
public class RabbitMQProducer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		rabbitTemplate.convertAndSend("MyProgrammaticTopicExchange","topic","**************** Hello from program at "+ LocalDateTime.now().toString()+"****************");
...
//		 }
		...
		//rabbitTemplate.convertAndSend("MyProgrammaticTopicExchange", "topic", "**************** END OF PROGRAM "+ LocalDateTime.now().toString() + "****************");
	}
}